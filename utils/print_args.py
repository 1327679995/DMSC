def print_args(args):
    ...
    print(f'  {"C Out:":<20}{args.c_out:<20}{"factor:":<20}{args.factor:<20}')
    print(f'  {"Embed:":<20}{args.embed:<20}{"Dropout:":<20}{args.dropout:<20}')
    print(f'  {"e layers:":<20}{args.e_layers:<20}{"Use norm:":<20}{args.use_norm:<20}')
    print()

    print("\033[1m" + "DMSC Parameters" + "\033[0m")
    print(f'  {"d model:":<20}{args.d_model:<20}{"d ff:":<20}{args.d_ff:<20}')
    print(f'  {"Balance Coeff:":<20}{args.balance_coeff:<20}{"Use Res:":<20}{args.use_res:<20}')
    print(f'  {"Num Shared:":<20}{args.num_shared:<20}{"Num Experts:":<20}{args.num_experts:<20}')
    print(f'  {"Top k:":<20}{args.top_k:<20}{"Patch length:":<20}{args.patch_len:<20}')
    print()
